...
class Router
{
    ...
    public function dispatch(string $requestUri, string $requestMethod, ?\App\Http\Request $request = null): void
    {
        ...
        foreach ($this->routes as $route) {
            ...
            if (preg_match($regex, $path, $matches)) {
                ...
                if ($firstParam && $firstParam->getType() && $firstParam->getType()->getName() === \App\Http\Request::class) {
    ...
    private function patternToRegex(string $pattern): string
    {
        ...
        // replace {param} with a capture group that doesn't accept slashes
